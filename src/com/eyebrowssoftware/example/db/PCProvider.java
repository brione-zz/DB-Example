...
public class PCProvider extends ContentProvider {
	...
	static {
		...
		sPingProjectionMap = new HashMap<String, String>();
		...
		sVisitItemProjectionMap = new HashMap<String, String>();
		...
		sNoteTypeProjectionMap = new HashMap<String, String>();
		...
		sTemperatureTypeProjectionMap = new HashMap<String, String>();
		...
		sClientProjectionMap = new HashMap<String, String>();
		...
		sVisitProjectionMap = new HashMap<String, String>();
		...
		sTemperatureProjectionMap = new HashMap<String, String>();
		...
		sClientVisitTemperatureProjectionMap = new HashMap<String, String>();
		...
		sClientVisitBPProjectionMap = new HashMap<String, String>();
		...
		sClientVisitLengthProjectionMap = new HashMap<String, String>();
		...
		sClientVisitPulseProjectionMap = new HashMap<String, String>();
		...
		sClientVisitWeightProjectionMap = new HashMap<String, String>();
